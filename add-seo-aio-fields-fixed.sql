-- Sprint 2: Add SEO and AIO tracking fields (FIXED)
...
-- 5. Create analytics table for tracking (FIXED - using TEXT for content_id)
CREATE TABLE IF NOT EXISTS content_analytics (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  content_id TEXT REFERENCES content_library(id) ON DELETE CASCADE,
  views INT DEFAULT 0,
...
-- 6. Create SEO issues table for tracking problems (FIXED - using TEXT for content_id)
