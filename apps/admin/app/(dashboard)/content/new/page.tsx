...
function NewContentForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/content/library/${content.id}`);
    } catch (err) {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <div>
        ...
        <h1 className="mt-2 text-2xl font-bold text-gray-900">Create New Content</h1>
        <p className="mt-1 text-sm text-gray-500">
          Create SEO and AI-optimized content
        </p>
      </div>
          ...
          <div className="rounded-lg bg-white p-6 shadow">
            ...
            <div className="mt-4">
              ...
              <input
                ...
                maxLength={60}
                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                placeholder="Optimized title for search engines (30-60 chars)"
              />
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                maxLength={160}
                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                placeholder="Compelling meta description (120-160 chars)"
              />
              <p className="mt-1 text-xs text-gray-500">
